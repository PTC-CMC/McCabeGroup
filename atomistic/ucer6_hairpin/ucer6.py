...
class ucer6(mb.Compound):
    def __init__(self):
        ...
        self.children[85].charge = 0.16
        self.children[86].charge = 0.09
        self.children[87].charge = -0.56
        self.children[88].charge = 0.31
        self.children[89].charge = -0.2
        self.children[90].charge = 0.1
        self.children[91].charge = 0.1
        ...
        self.children[125].charge = -0.18
        self.children[126].charge = 0.09
        self.children[127].charge = 0.09
        self.children[128].charge = -0.3
        self.children[129].charge = 0.1
        self.children[130].charge = 0.1
        self.children[131].charge = 0.1
        self.children[132].charge = 0.31
