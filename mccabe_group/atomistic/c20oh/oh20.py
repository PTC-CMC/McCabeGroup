...
class oh20(mb.Compound):
    def __init__(self):
        ...
        mb.load('oh20.mol2', compound=self, relative_to_module=self.__module__,
        ...
        self.children[24].charge = -0.181
        self.children[25].charge = 0.051
        self.children[26].charge = 0.09
        self.children[27].charge = 0.09
        self.children[28].charge = 0.09
        self.children[29].charge = 0.09
        self.children[30].charge = -0.65
        self.children[31].charge = 0.42
