...
class DSPC(mb.Compound):
    def __init__(self, use_atom_name=True):
        ...
        if use_atom_name:
            mb.load('DSPC_new.mol2', compound=self, relative_to_module=self.__module__, infer_hierarchy=False)
        else:
            mb.load('DSPC.mol2', compound=self, relative_to_module=self.__module__, infer_hierarchy=False)
        ...
        self.children[65].charge = -0.18
        self.children[66].charge = 0.09
        self.children[67].charge = 0.09
        self.children[68].charge = -0.18
