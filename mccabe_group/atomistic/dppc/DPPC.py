...
class DPPC(mb.Compound):
    def __init__(self, use_atom_name=True):
        ...
        if use_atom_name:
            mb.load('DPPC_new.mol2', compound=self, relative_to_module=self.__module__)
        else:
